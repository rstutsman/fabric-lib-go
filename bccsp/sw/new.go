...
func NewWithParams(securityLevel int, hashFamily string, keyStore bccsp.KeyStore) (bccsp.BCCSP, error) {
	...
	swbccsp.AddWrapper(reflect.TypeOf(&mldsa44PrivateKey{}), &mldsa44Signer{})
	...
	swbccsp.AddWrapper(reflect.TypeOf(&mldsa44PrivateKey{}), &mldsa44PrivateKeyVerifier{})
	swbccsp.AddWrapper(reflect.TypeOf(&mldsa44PublicKey{}), &mldsa44PublicKeyVerifier{})
	...
	swbccsp.AddWrapper(reflect.TypeOf(&bccsp.MLDSA44KeyGenOpts{}), &mldsa44KeyGenerator{})
	...
	swbccsp.AddWrapper(reflect.TypeOf(&bccsp.MLDSA44PrivateKeyImportOpts{}), &mldsa44PrivateKeyImportOptsKeyImporter{})
	swbccsp.AddWrapper(reflect.TypeOf(&bccsp.MLDSA44PublicKeyImportOpts{}), &mldsa44PublicKeyImportOptsKeyImporter{})
